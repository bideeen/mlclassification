...
def predictor(input_type, folder_or_image, model=None): # model argument can be substituted with a model of ours
    """ 
...
def main():
    ...
    predictor(input_type, folder_or_image) # add logic before here to pass in the model we want to use in the predictor
